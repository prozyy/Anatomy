...
def parse_args():
    ...
    # h36m_24
    parser.add_argument('-bi', '--boneindex', default='12,10,10,8,11,9,9,7,5,3,3,2,6,4,4,2,2,1,23,1,7,1,8,1,1,0,20,18,22,18,18,16,16,14,19,17,21,17,17,15,15,13,13,0,14,0', type=str, metavar='LIST', help='bone index (each two indexs correspond to the two joints a bone)')
    ...
    parser.add_argument('--viz-size', type=int, default=8, metavar='N', help='image size')
